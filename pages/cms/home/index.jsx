...
export default function Home() {
    return (
      ...
      <img
        ...
        />
        <Carousel.Caption>
          <h2 className={styles.heading}>Best solution to all your needs</h2>
          <p className={styles.para}>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
      <img
        ...
        />
        <Carousel.Caption>
          <h2 className={styles.heading}>Exclusive products</h2>
      ...
      <img
        ...
        />
        <Carousel.Caption>
          <h2 className={styles.heading}>Affordable with high quality</h2>
